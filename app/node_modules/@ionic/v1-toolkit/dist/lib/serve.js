...
function runServer(options) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        if (options.livereload) {
            reloadfn = yield dev_server_1.createLiveReloadServer({ port: options.livereloadPort, wwwDir: options.wwwDir });
        }
...
function createHttpServer(options) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        const wss = yield dev_server_1.createDevLoggerServer(options.devPort);
